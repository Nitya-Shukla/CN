...
**1. Topic: Network Models & Fundamentals**
    ...
    *   **OSI vs. TCP/IP:** ✅ [Completed - See cn_answers.md]
    ...
    *   **Connection-Oriented vs. Connectionless Services:** ✅ [Completed - See cn_answers.md]
...
**2. Topic: Data Link Layer (DLL) - Services & Error/Flow Control Concepts**
    ...
    *   **DLL Services:**
        *   [x] **DLL Services:**
            *   [x] Framing, Error Control, Flow Control, Access Control
    ...
    *   **Error Detection & Correction Mechanisms:**
        *   [x] **Error Detection & Correction Mechanisms:**
            *   [x] **Parity (Simple, 2D):**
...
**3. Topic: DLL Protocols (Sliding Window Protocols)**
    ...
    *   **Go-Back-N ARQ:**
        *   [x] **Working Principle:**
            *   [x] Sender window size (Ws > 1), Receiver window size (Wr = 1).
            *   [x] How it handles lost/damaged frames (sender retransmits the lost frame and all subsequent frames).
            *   [x] Cumulative ACKs (ACK N means all frames up to N-1 received).
        *   [x] **Diagram Scenarios:**
            *   [x] Successful transmission.
            *   [x] Frame loss (show retransmission of multiple frames).
            *   [x] Lost ACK (show how timeout or subsequent ACKs recover).
        *   [x] **Buffering:** Receiver doesn't buffer out-of-order frames.
        *   [x] **Recall Cue:** "Go back and resend all from error."
        *   [x] **Exam Angle (from pyqs.md):** "Explain working principle," "Diagram scenarios," "Compare with SR."

    *   **Selective Repeat ARQ:**
        *   [x] **Working Principle:**
            *   [x] Sender window size (Ws > 1), Receiver window size (Wr > 1, usually Ws = Wr).
            *   [x] How it handles lost/damaged frames (sender retransmits only the specific lost/damaged frame).
            *   [x] Individual ACKs (ACK N means frame N received).
            *   [x] Buffering at the receiver for out-of-order frames.
        *   [x] **Diagram Scenarios:**
            *   [x] Successful transmission.
            *   [x] Frame loss (show retransmission of only the lost frame and buffering at receiver).
            *   [x] Lost ACK.
        *   [x] **Recall Cue:** "Selectively repeat only the bad ones."
    ...
    *   **Comparison: Go-Back-N vs. Selective Repeat:**
        *   [x] Create a table comparing them based on:
            *   [x] Efficiency/Throughput (SR generally better).
            *   [x] Complexity (SR more complex).
            *   [x] Buffering requirements (SR needs more at receiver).
            *   [x] Number of retransmissions.
            *   [x] Window sizes.

**4. Topic: Framing & HDLC**

    *   **Framing Methods:**
        *   [x] **Character Count:** Explain, discuss problems (error in count).
        *   [x] **Character Stuffing (Byte Stuffing):**
            *   [x] Explain (using STX, ETX, DLE).
            *   [x] Provide an example of stuffing and destuffing.
        *   [x] **Bit Stuffing:**
            *   [x] Explain (inserting a 0 after a certain number of consecutive 1s).
            *   [x] Provide an example of stuffing and destuffing (use the May 2018 CBGS/GS problem as a template).
        *   [x] **Physical Layer Coding Violations:** Briefly explain the concept.
        *   [x] **Focus:** Deeply understand Bit Stuffing with examples.
        *   [x] **Exam Angle (from pyqs.md):** "Explain framing methods," "What is bit/byte stuffing? Explain with example," numerical bit stuffing problem.

    *   **HDLC (High-Level Data Link Control):**
        *   [x] **Frame Format:**
            *   [x] Draw the HDLC frame structure: `Flag | Address | Control | Information | FCS | Flag`.
            *   [x] For each field, briefly explain its purpose (e.g., Flag: 01111110, Address: for secondary station, Control: type of frame - I, S, U, Information: data, FCS: error detection).
        *   [x] (Optional, if time) Briefly mention the types of frames (Information, Supervisory, Unnumbered).
        *   [x] **Exam Angle (from pyqs.md):** "Draw frame format," "Explain use of fields."

**5. Topic: Introduction to MAC Sublayer & ALOHA**

    *   **Function of MAC layer:**
        *   [x] Explain its primary role: Controlling access to the shared medium.
        *   [x] Mention relation to DLL.
        *   [x] **Exam Angle (from pyqs.md):** "What is the function of MAC layer?"
...
**6. Review Day 1**
    ...
    *   [x] **Active Recall:** Without looking at notes, try to:
        *   [x] Draw OSI and TCP/IP models, label layers, and list one function for each.
        *   [x] Explain GBN vs. SR to an imaginary student, including diagrams for frame loss.
        *   [x] Explain pure vs. slotted ALOHA and their vulnerable periods.
    *   [x] **Identify Weak Spots:** Note any topics you struggled to recall and revisit them.
